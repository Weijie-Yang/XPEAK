...
# 保存并显示图形
plt.savefig(r"C:\Users\xzr\Desktop\paperpic\improved_correlation_matrix_NMF_exp_tp.png",
...
# 保存并显示图形
plt.savefig(r"C:\Users\xzr\Desktop\paperpic\improved_correlation_matrix_NMF_exp_Δtp.png",
           format='png', dpi=640, bbox_inches='tight')
plt.show()
import matplotlib.pyplot as plt
import numpy as np
