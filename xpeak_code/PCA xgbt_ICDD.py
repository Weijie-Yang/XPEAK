...
print("训练集合并后维度:", X_train_combined.shape)  # 应为 (样本数,)
...
xgbt = xgb.XGBRegressor(objective='reg:squarederror', learning_rate=0.5, gamma=1,
                        reg_alpha=0.2, reg_lambda=0.7, max_depth=3, 
...
xgbt = xgb.XGBRegressor(objective='reg:squarederror', learning_rate=0.45, gamma=0.9,
                        reg_alpha=0.5, reg_lambda=0.9, max_depth=4, 
                        min_child_weight=9, subsample=0.99, colsample_bytree=0.99,
                        random_state=42)
xgbt.fit(X_train_combined, y_train)
